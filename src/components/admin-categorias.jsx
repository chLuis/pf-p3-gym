...
export const AdminCategorias = () => {
  ...
  return (
    ...
    <div className='flex flex-col gap-2'>
      ...
      <FormCategoria getCategorias={fetchCategoriasAction} categoriaPatch={categoriaPatch} handleClean={handleClean}/>
        ...
        <div className='gap-2 w-full border'>
          <table className="border flex flex-col w-full">
            ...
            <tbody>
              ...
              <tr key={index} className={`${index % 2 === 0 ? "bg-black" : ""} grid grid-cols-2 hover:bg-primary hover:text-black items-center duration-200 min-w-fit`}>
                <td className="capitalize px-2">{categoria.nombre}</td>
                <td className="flex flex-nowrap gap-2 items-center justify-center">
                  <button onClick={() => setCategoriaPatch(categoria)}>Editar</button>
                  <DeleteCategoria id_categoria={categoria.id_categoria} getCategorias={fetchCategoriasAction}/>
                </td>
              </tr>
              )}
            </tbody>
