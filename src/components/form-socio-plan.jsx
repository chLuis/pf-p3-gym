...
export default function FormPlan({id_socio, getSocios}) {
  ...
  return (
    <form onSubmit={handleTime} className='flex flex-col gap-2 border h-fit p-4 rounded-md w-full'>
      ...
      <select onChange={(e) => setCantidad(+e.target.value)} className="p-1 border rounded-md placeholder:opacity-50">
        <option value={0} selected disabled className="text-black">Elegir</option>
