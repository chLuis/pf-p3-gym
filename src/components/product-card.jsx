...
export default function ProductCard({producto}) {
  return (
    <Link to={`${producto.id_producto}`} className="relative flex !text-primary flex-col border rounded-md overflow-clip  hover:shadow hover:shadow-primary duration-200 h-auto">
      <img src={producto.url || "https://http2.mlstatic.com/D_Q_NP_2X_652624-MLA73223130266_122023-E.webp"} alt={producto.nombre} className="aspect-square object-contain w-full h-auto"/>
      <div className="px-2 pt-1 pb-6">
        ...
        ? <div className="pt-1">
            <div className="absolute top-3 right-3 font-rubik-dirt bg-red-700 text-white rounded-4xl px-3">{producto.descuento}% OFF</div>
