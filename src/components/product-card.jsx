...
export default function ProductCard({producto}) {
  return (
    <Link to={`${producto.id_producto}`} className="flex !text-primary flex-col border rounded-md overflow-clip  hover:shadow hover:shadow-primary duration-200 h-auto">
      ...
      <div className="px-2 pt-1 pb-6">
        ...
        <div className="text-xs">Marca: <span className="font-bold text-sm">{producto.marca}</span></div>
